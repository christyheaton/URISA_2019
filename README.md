...
* If you are familiar with [GitHub](http://www.github.com), fork (if you wish) and clone [the repository](https://github.com/christyheaton/URISA_2019). If not, download the repository and unzip to a working directory. Take note of where you put it!
...
```bash
cd [location where you saved the repo]/URISA_2019
```
